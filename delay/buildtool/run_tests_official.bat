...
ctest -V -C Release --exclude-regex "test_matlab_binding" >> %BUILDTOOL_DIR%\test_log32.txt
...
:ctest -V -C Release --exclude-regex "test_matlab_binding" >> %BUILDTOOL_DIR%\test_log32p.txt
...
ctest -V -C Release --exclude-regex "test_matlab_binding" >> %BUILDTOOL_DIR%\test_log64.txt
...
:ctest -V -C Release --exclude-regex "test_matlab_binding" >> %BUILDTOOL_DIR%\test_log64p.txt
