...
cmake -DSRC_DIR=%LIBSBML_SRC% -DBUILD_DIR=%THIS_DIR%\python-src\build\lib.win-amd64-3.8 -DOUT_DIR=%THIS_DIR%\out -DNAME=%NAME% -P source\create-conda-archives.cmake
...
cmake -DSRC_DIR=%LIBSBML_SRC% -DBUILD_DIR=%THIS_DIR%\python-src\build\lib.win32-3.8 -DOUT_DIR=%THIS_DIR%\out -DNAME=%NAME% -P source\create-conda-archives.cmake
