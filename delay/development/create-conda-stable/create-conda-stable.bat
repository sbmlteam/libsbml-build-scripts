...
cmake -DSRC_DIR=c:\Development\libsbml -DBUILD_DIR=%THIS_DIR%\build\lib.win-amd64-3.7 -DOUT_DIR=%THIS_DIR%\out\64 -DNAME=%NAME% -P create-conda-archives.cmake
cmake -DSRC_DIR=c:\Development\libsbml -DBUILD_DIR=%THIS_DIR%\build\lib.win32-3.7 -DOUT_DIR=%THIS_DIR%\out\32 -DNAME=%NAME% -P create-conda-archives.cmake
