...
SET OLD_DEPENDENCIES_DIR=c:\tools\libsbml_old_dependencies\libSBML-4.2.0-libxml2-x86\win32
...
copy %LIBSBML_ROOT%\src\bindings\matlab\isFbcEnabled.m  isFbcEnabled.m
...
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%VERSION%.win32-py3.2.exe" libSBML-%VERSION%-win-py3.2-x86.exe
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%VERSION%.win32-py3.3.exe" libSBML-%VERSION%-win-py3.3-x86.exe
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%VERSION%.win32-py3.4.exe" libSBML-%VERSION%-win-py3.4-x86.exe
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%VERSION%.win32-py3.5.exe" libSBML-%VERSION%-win-py3.5-x86.exe
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%VERSION%.win32-py3.6.exe" libSBML-%VERSION%-win-py3.6-x86.exe
