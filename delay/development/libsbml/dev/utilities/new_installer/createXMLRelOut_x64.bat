...
SET INSTALL_DIR=c:\Development\libsbml-64-inst
...
SET OLD_DEPENDENCIES_DIR=c:\tools\libsbml_old_dependencies\libSBML-4.2.0-libxml2-x64\win64
...
copy %LIBSBML_ROOT%\examples\xslt\layout\layout2svg.xsl xslt\layout\layout2svg.xsl
...
copy %LIBSBML_ROOT%\examples\c\promoteParameters.c promoteParameters.c
copy %LIBSBML_ROOT%\examples\c\readSBML.c readSBML.c
copy %LIBSBML_ROOT%\examples\c\stripPackage.c stripPackage.c
...
copy %LIBSBML_ROOT%\examples\c\comp\*.c comp\
...
copy "%LIBSBML_ROOT%\examples\c++\getAllElementsWithNotes.cpp" getAllElementsWithNotes.cpp
copy "%LIBSBML_ROOT%\examples\c++\inferUnits.cpp" inferUnits.cpp
copy "%LIBSBML_ROOT%\examples\c++\inlineFunctionDefintions.cpp" inlineFunctionDefintions.cpp
...
copy "%LIBSBML_ROOT%\examples\c++\promoteParameters.cpp" promoteParameters.cpp
copy "%LIBSBML_ROOT%\examples\c++\readSBML.cpp" readSBML.cpp
copy "%LIBSBML_ROOT%\examples\c++\renameSId.cpp" renameSId.cpp
copy "%LIBSBML_ROOT%\examples\c++\rngvalidator.cpp" rngvalidator.cpp
copy "%LIBSBML_ROOT%\examples\c++\setIdFromNames.cpp" setIdFromNames.cpp
copy "%LIBSBML_ROOT%\examples\c++\setNamesFromIds.cpp" setNamesFromIds.cpp
copy "%LIBSBML_ROOT%\examples\c++\stripPackage.cpp" stripPackage.cpp
...
copy "%LIBSBML_ROOT%\examples\c++\comp\flattenModel.cpp" comp\flattenModel.cpp
copy "%LIBSBML_ROOT%\examples\c++\comp\SBMLHttpResolverExample.cpp" comp\SBMLHttpResolverExample.cpp
copy "%LIBSBML_ROOT%\examples\c++\comp\spec_example1.cpp" comp\spec_example1.cpp
copy "%LIBSBML_ROOT%\examples\c++\comp\spec_example2.cpp" comp\spec_example2.cpp
copy "%LIBSBML_ROOT%\examples\c++\comp\spec_example3.cpp" comp\spec_example3.cpp
copy "%LIBSBML_ROOT%\examples\c++\comp\spec_example4.cpp" comp\spec_example4.cpp

copy "%LIBSBML_ROOT%\examples\c++\fbc\convertCobraToFbc.cpp" fbc\convertCobraToFbc.cpp
copy "%LIBSBML_ROOT%\examples\c++\fbc\convertFbcToCobra.cpp" fbc\convertFbcToCobra.cpp
copy "%LIBSBML_ROOT%\examples\c++\fbc\fbc_example1.cpp" fbc\fbc_example1.cpp

copy "%LIBSBML_ROOT%\examples\c++\layout\addLayout.cpp" layout\addLayout.cpp
copy "%LIBSBML_ROOT%\examples\c++\layout\convertLayout.cpp" layout\convertLayout.cpp
copy "%LIBSBML_ROOT%\examples\c++\layout\example1.cpp" layout\example1.cpp
copy "%LIBSBML_ROOT%\examples\c++\layout\example1-L3.cpp" layout\example1-L3.cpp
copy "%LIBSBML_ROOT%\examples\c++\layout\example2.cpp" layout\example2.cpp
copy "%LIBSBML_ROOT%\examples\c++\layout\example2-L3.cpp" layout\example2-L3.cpp
copy "%LIBSBML_ROOT%\examples\c++\layout\example3.cpp" layout\example3.cpp
copy "%LIBSBML_ROOT%\examples\c++\layout\example3-L3.cpp" layout\example3-L3.cpp

copy "%LIBSBML_ROOT%\examples\c++\qual\qual_example1.cpp" qual\qual_example1.cpp
...
copy %LIBSBML_ROOT%\examples\java\getAllElementsWithNotes.java getAllElementsWithNotes.java
...
copy %LIBSBML_ROOT%\examples\java\promoteParameters.java promoteParameters.java
copy %LIBSBML_ROOT%\examples\java\readSBML.java readSBML.java
copy %LIBSBML_ROOT%\examples\java\setIdFromNames.java setIdFromNames.java
copy %LIBSBML_ROOT%\examples\java\stripPackage.java stripPackage.java
...
copy %LIBSBML_ROOT%\examples\java\comp\*.java comp\
copy %LIBSBML_ROOT%\examples\java\fbc\*.java fbc\
copy %LIBSBML_ROOT%\examples\java\layout\*.java layout\
copy %LIBSBML_ROOT%\examples\java\qual\*.java qual\
...
copy %LIBSBML_ROOT%\examples\perl\promoteParameters.pl promoteParameters.pl
copy %LIBSBML_ROOT%\examples\perl\readSBML.pl readSBML.pl
copy %LIBSBML_ROOT%\examples\perl\stripPackage.pl stripPackage.pl
...
copy %LIBSBML_ROOT%\examples\perl\comp\*.pl comp\
copy %LIBSBML_ROOT%\examples\perl\fbc\*.pl fbc\
copy %LIBSBML_ROOT%\examples\perl\layout\*.pl layout\
...
copy %LIBSBML_ROOT%\examples\csharp\GetAllElementsWithNotes.cs GetAllElementsWithNotes.cs
...
copy %LIBSBML_ROOT%\examples\csharp\promoteParameters.cs promoteParameters.cs
copy %LIBSBML_ROOT%\examples\csharp\readSBML.cs readSBML.cs
copy %LIBSBML_ROOT%\examples\csharp\SetIdFromNames.cs SetIdFromNames.cs
copy %LIBSBML_ROOT%\examples\csharp\stripPackage.cs stripPackage.cs
...
copy %LIBSBML_ROOT%\examples\csharp\comp\*.cs comp\
copy %LIBSBML_ROOT%\examples\csharp\fbc\*.cs fbc\
copy %LIBSBML_ROOT%\examples\csharp\layout\*.cs layout\
copy %LIBSBML_ROOT%\examples\csharp\qual\*.cs qual\
...
copy %LIBSBML_ROOT%\examples\python\getAllElementsWithNotes.py getAllElementsWithNotes.py
...
copy %LIBSBML_ROOT%\examples\python\promoteParameters.py promoteParameters.py
copy %LIBSBML_ROOT%\examples\python\readSBML.py readSBML.py
copy %LIBSBML_ROOT%\examples\python\setIdFromNames.py setIdFromNames.py
copy %LIBSBML_ROOT%\examples\python\stripPackage.py stripPackage.py
...
copy %LIBSBML_ROOT%\examples\python\comp\*.py comp\
copy %LIBSBML_ROOT%\examples\python\fbc\*.py fbc\
copy %LIBSBML_ROOT%\examples\python\layout\*.py layout\
copy %LIBSBML_ROOT%\examples\python\qual\*.py qual\
...
rem bindings/nodejs directory
copy %INSTALL_DIR%\bindings\nodejs\sbml.node nodejs\sbml.node
...
copy /y "%INSTALL_DIR_32%\bindings\python\src\dist\libsbml-%VERSION%.win-amd64-py3.2.exe" libSBML-%VERSION%-win-py3.2-amd64.exe
copy /y "%INSTALL_DIR_32%\bindings\python\src\dist\libsbml-%VERSION%.win-amd64-py3.3.exe" libSBML-%VERSION%-win-py3.3-amd64.exe
copy /y "%INSTALL_DIR_32%\bindings\python\src\dist\libsbml-%VERSION%.win-amd64-py3.4.exe" libSBML-%VERSION%-win-py3.4-amd64.exe
copy /y "%INSTALL_DIR_32%\bindings\python\src\dist\libsbml-%VERSION%.win-amd64-py3.5.exe" libSBML-%VERSION%-win-py3.5-amd64.exe
copy /y "%INSTALL_DIR_32%\bindings\python\src\dist\libsbml-%VERSION%.win-amd64-py3.6.exe" libSBML-%VERSION%-win-py3.6-amd64.exe
