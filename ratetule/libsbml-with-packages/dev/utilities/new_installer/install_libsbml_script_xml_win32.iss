; Version No is currently 5.17.3
; Check before use


[Setup]
AppName=libSBML
AppVerName=libSBML 5.17.3
AppPublisher=SBML Team
AppPublisherURL=http://sbml.org
AppSupportURL=http://sbml.org
AppUpdatesURL=http://sbml.org
DefaultDirName={pf}\SBML\libSBML-5.17.3-libxml2-x86
DefaultGroupName=libSBML
DisableProgramGroupPage=yes
OutputDir=.\Output
OutputBaseFilename=libSBML-5.17.3-win-x86
...
Root: HKLM; Subkey: Software\SBML\libSBML; ValueType: string; ValueName: Version; ValueData: 5.17.3
...
**********************************************************************************************************}
  MsgBox('This setup installs the Windows version of libSBML 5.17.3 built using the libxml2 2.7.3 XML Parser library. All the necessary libraries are included. The source code is available as a separate download.', mbInformation, mb_Ok);
end;
...
Filename: "{app}\bindings\python\libSBML-5.17.3-win-py2.5-x86.exe"; Check: GetPython25;
Filename: "{app}\bindings\python\libSBML-5.17.3-win-py2.6-x86.exe"; Check: GetPython26;
Filename: "{app}\bindings\python\libSBML-5.17.3-win-py2.7-x86.exe"; Check: GetPython27;
Filename: "{app}\bindings\python\libSBML-5.17.3-win-py3.2-x86.exe"; Check: GetPython32;
Filename: "{app}\bindings\python\libSBML-5.17.3-win-py3.4-x86.exe"; Check: GetPython34;
Filename: "{app}\bindings\python\libSBML-5.17.3-win-py3.5-x86.exe"; Check: GetPython34;
Filename: "{app}\bindings\matlab\libSBML-5.17.3-win-matlab-x86.exe"; Check: GetMatlab;
