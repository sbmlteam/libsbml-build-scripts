...
REM the next line.
SET ZIP_DIR=c:/inetpub/wwwroot/Files
...
SET DEPENDENCIES_64_BIT=c:\Development\dependencies\64bit
...
cmake -G "NMake Makefiles" -DCMAKE_INSTALL_PREFIX=c:\Development\libsbml-32-inst-package -DCMAKE_SIZEOF_VOID_P=4 %LIBSBML_ROOT% 
cmake -G "NMake Makefiles" -DCMAKE_INSTALL_PREFIX=c:\Development\libsbml-32-inst-package -DCMAKE_SIZEOF_VOID_P=4 %LIBSBML_ROOT% 
nmake
rd /s /q c:\Development\libsbml-32-inst-package\include
rd /s /q c:\Development\libsbml-32-inst-package\win32\include
rd /s /q c:\Development\libsbml-32-inst-package\win64\include
nmake install
...
cmake -G "Visual Studio 10 Win64" -DCMAKE_INSTALL_PREFIX=c:\Development\libsbml-64-inst-package -DCMAKE_SIZEOF_VOID_P=8 %LIBSBML_ROOT% 
cmake -G "Visual Studio 10 Win64" -DCMAKE_INSTALL_PREFIX=c:\Development\libsbml-64-inst-package -DCMAKE_SIZEOF_VOID_P=8 %LIBSBML_ROOT%  
devenv libsbml.sln /build Release
rd /s /q c:\Development\libsbml-64-inst-package\include
devenv libsbml.sln /build Release /project INSTALL
