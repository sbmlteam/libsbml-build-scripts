...
SET LIBSBML_SRC=C:/Development/libsbml-with-packages
SET LIBSBML_32=C:/Development/libsbml-32-inst-package/lib/libsbml-static.lib
SET LIBSBML_64=C:/Development/libsbml-64-inst-package/lib/libsbml-static.lib
...
pushd %CURRENT_DIR%
:: copy new files
copy /y C:\Development\libsbml-32-packages\src\bindings\r\*.cpp . 
copy /y C:\Development\libsbml-32-packages\src\bindings\swig\*.h swig
rd /s /q sbml
mkdir sbml
xcopy /y /s C:\Development\libsbml-32-inst-package\include\sbml sbml
...
cmake -DEXTRA_DEFS="USE_COMP;USE_LAYOUT;USE_FBC;USE_QUAL;USE_RENDER;USE_SPATIAL;USE_REQUIREDELEMENTS;USE_MULTI;USE_GROUPS;USE_DYN;USE_DISTRIB;USE_ARRAYS" ..
nmake
