This installation package will install libSBML for MacOS 10.5 or later, for both i386 and x86_64 architectures. By default, it will put the contents in /usr/local, but this location can be changed from the installer interface.
