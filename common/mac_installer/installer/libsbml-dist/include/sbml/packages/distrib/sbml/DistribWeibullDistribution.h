...
public:
   ...
   * DistribWeibullDistribution.
   *
   * @return the value of the "id" attribute of this DistribWeibullDistribution
   * as a string.
   */
   ...
   * DistribWeibullDistribution as a string.
   */
   ...
   * attribute is set.
   *
   * @return @c true if this DistribWeibullDistribution's "id" attribute has
   ...
   * attribute is set.
   *
   * @return @c true if this DistribWeibullDistribution's "name" attribute has
   * been set, otherwise @c false is returned.
   */
 ...
 * DistribWeibullDistribution_t.
 *
 * @param dwd the DistribWeibullDistribution_t structure whose id is sought.
 *
 * @return the value of the "id" attribute of this DistribWeibullDistribution_t
 ...
 * DistribWeibullDistribution_t.
 *
 * @param dwd the DistribWeibullDistribution_t structure whose name is sought.
 *
 * @return the value of the "name" attribute of this
 * DistribWeibullDistribution_t as a pointer to a string.
 *
 * @copydetails doc_returned_owned_char
 *
 * @memberof DistribWeibullDistribution_t
 ...
 * @param dwd the DistribWeibullDistribution_t structure.
 *
 * @return @c 1 (true) if this DistribWeibullDistribution_t's "id" attribute
 ...
 * @param dwd the DistribWeibullDistribution_t structure.
 *
 * @return @c 1 (true) if this DistribWeibullDistribution_t's "name" attribute
 * has been set, otherwise @c 0 (false) is returned.
 *
 * @memberof DistribWeibullDistribution_t
 */
 ...
 * to calling DistribWeibullDistribution_unsetId().
 *
 * @memberof DistribWeibullDistribution_t
 */
LIBSBML_EXTERN
 ...
 *
 * Calling this function with @p name = @c NULL or an empty string is
 * equivalent to calling DistribWeibullDistribution_unsetName().
 *
 * @memberof DistribWeibullDistribution_t
 */
LIBSBML_EXTERN
