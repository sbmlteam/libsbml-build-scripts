/**
 * @file DistribRayleighDistribution.h
 * @brief Definition of the DistribRayleighDistribution class.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
 ...
 * @sbmlbrief{distrib} TODO:Definition of the DistribRayleighDistribution
 * class.
 */


#ifndef DistribRayleighDistribution_H__
#define DistribRayleighDistribution_H__
...
class LIBSBML_EXTERN DistribRayleighDistribution : public
...
public:
   ...
   * this DistribRayleighDistribution.
   *
   ...
   * @copydetails doc_note_setting_lv_pkg
   */
  DistribRayleighDistribution(DistribPkgNamespaces *distribns);


  /**
   * Copy constructor for DistribRayleighDistribution.
   *
   * @param orig the DistribRayleighDistribution instance to copy.
   */
  DistribRayleighDistribution(const DistribRayleighDistribution& orig);


  /**
   * Assignment operator for DistribRayleighDistribution.
   *
   * @param rhs the DistribRayleighDistribution object whose values are to be
   * used as the basis of the assignment.
   */
  DistribRayleighDistribution& operator=(const DistribRayleighDistribution&
    rhs);


  /**
   * Creates and returns a deep copy of this DistribRayleighDistribution
   * object.
   *
   * @return a (deep) copy of this DistribRayleighDistribution object.
   */
  virtual DistribRayleighDistribution* clone() const;


  /**
   * Destructor for DistribRayleighDistribution.
   */
  virtual ~DistribRayleighDistribution();
   ...
   * DistribRayleighDistribution as a string.
   */
   ...
   * attribute is set.
   *
   * @return @c true if this DistribRayleighDistribution's "id" attribute has
   ...
   * attribute is set.
   *
   * @return @c true if this DistribRayleighDistribution's "name" attribute has
   * been set, otherwise @c false is returned.
   */
   ...
   * element is set.
   *
   * @return @c true if this DistribRayleighDistribution's "scale" element has
   * been set, otherwise @c false is returned.
   */
   ...
   *
   * For DistribRayleighDistribution, the XML element name is always
   * @c "rayleighDistribution".
   *
   * @return the name of this element, i.e. @c "rayleighDistribution".
   */
   ...
   * @sbmlconstant{SBML_DISTRIB_RAYLEIGHDISTRIBUTION, SBMLDistribTypeCode_t}.
   *
   ...
   * DistribRayleighDistribution have been set, otherwise @c false is returned.
   */
   ...
   *
   *
   * @note The required elements for the DistribRayleighDistribution object
   * are:
   * @li "scale"
   */
  ...
  /**
   * Predicate returning @c true if this DistribRayleighDistribution's
   * attribute "attributeName" is set.
   *
   * @param attributeName, the name of the attribute to query.
   *
   * @return @c true if this DistribRayleighDistribution's attribute
 ...
 *
 * @param pkgVersion an unsigned int, the SBML Distrib Version to assign to
 * this DistribRayleighDistribution_t.
 *
 * @copydetails doc_note_setting_lv_pkg
 *
 * @copydetails doc_returned_owned_pointer
 *
 * @memberof DistribRayleighDistribution_t
 */
LIBSBML_EXTERN
DistribRayleighDistribution_t *
 ...
 * object.
 *
 * @param drd the DistribRayleighDistribution_t structure.
 *
 * @return a (deep) copy of this DistribRayleighDistribution_t object.
 *
 * @copydetails doc_returned_owned_pointer
 *
 * @memberof DistribRayleighDistribution_t
 ...
 * DistribRayleighDistribution_t.
 *
 * @param drd the DistribRayleighDistribution_t structure whose id is sought.
 *
 * @return the value of the "id" attribute of this
 * DistribRayleighDistribution_t as a pointer to a string.
 *
 ...
 * DistribRayleighDistribution_t.
 *
 * @param drd the DistribRayleighDistribution_t structure whose name is sought.
 *
 * @return the value of the "name" attribute of this
 * DistribRayleighDistribution_t as a pointer to a string.
 *
 ...
 * @param drd the DistribRayleighDistribution_t structure.
 *
 * @return @c 1 (true) if this DistribRayleighDistribution_t's "id" attribute
 ...
 * @param drd the DistribRayleighDistribution_t structure.
 *
 * @return @c 1 (true) if this DistribRayleighDistribution_t's "name" attribute
 * has been set, otherwise @c 0 (false) is returned.
 *
 * @memberof DistribRayleighDistribution_t
 */
 ...
 * to calling DistribRayleighDistribution_unsetId().
 *
 * @memberof DistribRayleighDistribution_t
 */
LIBSBML_EXTERN
 ...
 *
 * Calling this function with @p name = @c NULL or an empty string is
 * equivalent to calling DistribRayleighDistribution_unsetName().
 *
 * @memberof DistribRayleighDistribution_t
 */
LIBSBML_EXTERN
 ...
 * DistribRayleighDistribution_t.
 *
 * @param drd the DistribRayleighDistribution_t structure whose scale is
 * sought.
 *
 * @return the value of the "scale" element of this
 * DistribRayleighDistribution_t as a DistribUncertValue*.
 *
 * @memberof DistribRayleighDistribution_t
 */
LIBSBML_EXTERN
const DistribUncertValue_t*
DistribRayleighDistribution_getScale(const DistribRayleighDistribution_t *
  drd);
 ...
 * @param drd the DistribRayleighDistribution_t structure.
 *
 * @return @c 1 (true) if this DistribRayleighDistribution_t's "scale" element
 * has been set, otherwise @c 0 (false) is returned.
 *
 * @memberof DistribRayleighDistribution_t
 */
 ...
 * object created.
 *
 * @param drd the DistribRayleighDistribution_t structure to which the
 ...
 * DistribRayleighDistribution_t have been set, otherwise @c 0 (false) is
 * returned.
 *
 * @memberof DistribRayleighDistribution_t
 */
 ...
 *
 *
 * @note The required elements for the DistribRayleighDistribution_t object
 * are:
 * @li "scale"
 *
 * @memberof DistribRayleighDistribution_t
...
#endif /* !DistribRayleighDistribution_H__ */
