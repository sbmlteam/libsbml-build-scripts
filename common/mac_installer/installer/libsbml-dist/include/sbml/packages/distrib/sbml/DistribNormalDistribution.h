...
public:
   ...
   *
   * @return the value of the "id" attribute of this DistribNormalDistribution
   * as a string.
   */
   ...
   * DistribNormalDistribution as a string.
   */
   ...
   * attribute is set.
   *
   * @return @c true if this DistribNormalDistribution's "id" attribute has
   ...
   * attribute is set.
   *
   * @return @c true if this DistribNormalDistribution's "name" attribute has
   * been set, otherwise @c false is returned.
   */
 ...
 *
 * @param dnd the DistribNormalDistribution_t structure whose id is sought.
 *
 * @return the value of the "id" attribute of this DistribNormalDistribution_t
 ...
 * DistribNormalDistribution_t.
 *
 * @param dnd the DistribNormalDistribution_t structure whose name is sought.
 *
 * @return the value of the "name" attribute of this
 * DistribNormalDistribution_t as a pointer to a string.
 *
 * @copydetails doc_returned_owned_char
 *
 * @memberof DistribNormalDistribution_t
 ...
 * @param dnd the DistribNormalDistribution_t structure.
 *
 * @return @c 1 (true) if this DistribNormalDistribution_t's "id" attribute has
 ...
 * @param dnd the DistribNormalDistribution_t structure.
 *
 * @return @c 1 (true) if this DistribNormalDistribution_t's "name" attribute
 ...
 * to calling DistribNormalDistribution_unsetId().
 *
 * @memberof DistribNormalDistribution_t
 */
LIBSBML_EXTERN
 ...
 *
 * Calling this function with @p name = @c NULL or an empty string is
 * equivalent to calling DistribNormalDistribution_unsetName().
 *
 * @memberof DistribNormalDistribution_t
 */
LIBSBML_EXTERN
